                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('courier.update', $courier->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" name="name" value="{{$courier->name}}" id="firstName" placeholder="Courier Name" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            <label  class="col-md-3 form-label">Courier Status</label>
                            <div class="col-md-9">
