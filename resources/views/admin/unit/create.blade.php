                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('unit.store')}}" method="POST" >
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" name="name" id="name" placeholder="Enter Unit Name" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="code" class="col-md-3 form-label">Unit Code</label>
                            <div class="col-md-9">
                                <input class="form-control" name="code" id="code" placeholder="Enter Unit Code" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="description" class="col-md-3 form-label">Unit Description</label>
                            <div class="col-md-9">
                                <textarea class="form-control" name="description" id="description" placeholder="Enter Unit Description" ></textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
